/**
 * POST /api/operator/interventions/:id/reject
 *
 * Reject a pending intervention. The goal will not resume.
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.error('[/api/operator/interventions/:id/reject] Error:', error);
    res.status(500).json({
