...
export class FinanceAgent extends BaseAgent {
  ...
  public createFinancialReport(type: string): any {
    return { type, generated_at: new Date().toISOString(), generated_by: this.id, treasury: this.treasury, metrics: this.metrics, alerts: this.alerts, recommendations: this.generateRecommendations(), summary: this.generateSummary() };
  }
