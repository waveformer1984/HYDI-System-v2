...
export class MarketingAgent extends BaseAgent {
  ...
  private createBrandAwarenessStrategy(payload: any): any {
    return {
      ...
      kpis: { reach: payload.target_reach || 100000, engagement_rate: '3-5%', brand_lift: '10-15%' }
    };
  }
  ...
  private createProductLaunchPlan(payload: any): any {
    return {
      ...
      target_metrics: { signups: payload.target_signups || 1000, activation_rate: '25%', retention_30day: '60%' }
    };
  }
