...
| `HEIDI_HISTORY_TURNS` | Number of recent in-session message rows injected into the prompt for short-term conversational coherence (default `6`; two rows per turn). Session-scoped — a new session starts clean |
