...
describe('20260617000001_heidi_orchestrator_schema', () => {
  let sql;
  beforeAll(() => {
    sql = readMigration('20260617000001_heidi_orchestrator_schema.sql').toLowerCase();
  });

  // ── offers (HeidiRevenueEngine persistence) ────────────────────────────────
  ...
  // ── heidi_reflection_snapshots (HeidiMemorySystem blob snapshots) ───────────
  ...
  // ── guard: public.reflections is a VIEW and must never be altered ───────────
