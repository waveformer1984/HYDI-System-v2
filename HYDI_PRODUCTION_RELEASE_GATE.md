...
| Timestamp | 2026-08-24T05:17:47.586Z |
| Total Duration | 371.7s |
...
| G06 | SSE consistency | PASS | Yes | 1ms | SSE replay safety verified in crash/restart matrix; transport-only verified in dashboard hardening |
...
| G14 | Git cleanliness check | FAIL | Yes | 192ms | 35 uncommitted changes: M .gitignore,  M HEIDI_REAL_COGNITIVE_CYCLE_REPORT.md, ?? .github/workflows/rezonate-capability-contract.yml, ?? HARD_ACCEPTANCE_AUDIT_REPORT.md, ?? HEIDI_STATE_OF_THE_SYSTEM.md |
...
- **G14 Git cleanliness check**: 35 uncommitted changes: M .gitignore,  M HEIDI_REAL_COGNITIVE_CYCLE_REPORT.md, ?? .github/workflows/rezonate-capability-contract.yml, ?? HARD_ACCEPTANCE_AUDIT_REPORT.md, ?? HEIDI_STATE_OF_THE_SYSTEM.md
