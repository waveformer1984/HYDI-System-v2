...
const PERMISSIONS = Object.freeze({
  ...
  operator: [
    ...
    'credentials:view',
    'credentials:probe',
    'credentials:rotate',        // operator may rotate TEST credentials only
    'credentials:rotate:test',   // explicit test-only rotation scope
  ...
  viewer: [
    ...
    'revenue:view',
    'traces:view',
    'credentials:view',          // viewer may see credential metadata (no values)
  ],
});
